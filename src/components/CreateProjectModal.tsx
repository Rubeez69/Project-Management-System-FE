  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const projectData = {
        name: projectName,
        startDate,
        endDate: endDate || undefined, // Only include if provided
        description,
      ...
      if (error.response) {
        try {
          ...
          if (errorData.code === 409) {
            ...
            setErrors({
              ...newErrors,
              api: errorData.message || 'Failed to create project'
            });
          }
        } catch (parseError) {
          setErrors({
            ...newErrors,
            api: 'Failed to create project: Server error'
          });
        }
      ...
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="modal-actions">
            ...
            <button 
              type="submit" 
              className="action-button submit-button-pm"
              disabled={loading}
            >
